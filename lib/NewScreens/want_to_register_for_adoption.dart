...
class WantToRegisterForAdoption extends StatefulWidget {
  @override
  _WantToRegisterForAdoptionState createState() =>
      _WantToRegisterForAdoptionState();
}

class _WantToRegisterForAdoptionState extends State<WantToRegisterForAdoption> {
