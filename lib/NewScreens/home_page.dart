...
import 'package:hookup4u2/NewScreens/messages_page.dart';
import 'package:hookup4u2/NewScreens/new_home_page_container.dart';
import 'package:hookup4u2/NewScreens/new_notification.dart';
import 'package:hookup4u2/NewScreens/pet_name.dart';
import 'package:hookup4u2/NewScreens/static_profile.dart';
import 'package:hookup4u2/Screens/Calling/incomingCall.dart';
import 'package:hookup4u2/Screens/Chat/home_screen.dart';
import 'package:hookup4u2/Screens/Home.dart';
import 'package:hookup4u2/Screens/PetAdoption/pet_adoption.dart';
import 'package:hookup4u2/Screens/Profile/profile.dart';
import 'package:hookup4u2/Screens/Splash.dart';
import 'package:hookup4u2/Screens/blockUserByAdmin.dart';
import 'package:hookup4u2/Screens/notifications.dart';
...
class NewHomePage extends StatefulWidget {
  ...
  final String plan;
  NewHomePage(this.plan, this.isPaymentSuccess);
  @override
              ...
              appBar: AppBar(
                ...
                title: TabBar(
                    ...
                    tabs: [
                      ...
                      // Tab(
                      //     icon: Image.asset(
                      //         "asset/Icon/download-removebg-preview.png")),
                    ]),
              ),
              body: TabBarView(
                children: [
                  Center(child: StaticProfile()),
                  Center(child: NewHomePageContainer()),
                  Center(child: NewNotification()),
                  Center(child: MessagesPage()),
                ],
