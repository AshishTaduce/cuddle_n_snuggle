...
import 'package:hookup4u2/NewScreens/pet_adoption.dart';
import 'package:hookup4u2/util/color.dart';
import 'package:hookup4u2/util/snackbar.dart';

class PetSex extends StatefulWidget {
  @override
  _PetSexState createState() => _PetSexState();
}

class _PetSexState extends State<PetSex> {
  bool man = false;
  bool woman = false;
  bool other = false;
  bool select = false;
          ...
          Padding(
            ...
            child: Align(
              ...
              child: ListTile(
                ...
                title: Text("Show my pet's gender on my profile"),
              ),
            ),
          ),
          man || woman || other
