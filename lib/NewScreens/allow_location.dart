...
import 'package:hookup4u2/Screens/UpdateLocation.dart';
import 'package:hookup4u2/Screens/seach_location.dart';
import 'package:hookup4u2/util/color.dart';

class NewAllowLocation extends StatefulWidget {
  @override
  _NewAllowLocationState createState() => _NewAllowLocationState();
}

class _NewAllowLocationState extends State<NewAllowLocation> {
  @override
