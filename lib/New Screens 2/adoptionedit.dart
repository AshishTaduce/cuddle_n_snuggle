...
class AdoptionEdit extends StatefulWidget {
  ...
  const AdoptionEdit(
      ...
      : super(key: key);
  @override
  _AdoptionEditState createState() => _AdoptionEditState();
}

class _AdoptionEditState extends State<AdoptionEdit> {
  ...
  Future getImage(
    ...
    if (image != null) {
      ...
      if (croppedFile != null) {
        ...
        uploadFile(File(image.path), currentUser, isProfilePicture);
      }
    }
    Navigator.pop(context);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            GradientAppBar("Edit Adoption Details"),
