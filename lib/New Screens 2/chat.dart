...
class _ChatPageState extends State<ChatPage> {
    ...
    return snapshot.data!.docs
        .map<Widget>((doc) => Container(
              ...
              child: new Row(
                ...
                children:
                    (doc.data() as Map)['sender_id'] != widget.currentUser.id
  ...
  Widget getDefaultSendButton() {
    return IconButton(
      ...
      color: primaryColor,
      onPressed:
          _isWriting ? () => _sendText(_textController.text.trimRight()) : null,
    );
  }
              ...
              new Flexible(
                child: new TextField(
                  ...
                  onChanged: (String messageText) {
                    setState(() {
                      _isWriting = messageText.trim().length > 0;
                    });
                  },
