...
class _SubscriptionState extends State<Subscription> {
  ...
  void _initialize() async {
    ...
    if (isAvailable) {
      ...
      _streamSubscription = _iap.purchaseUpdatedStream.listen(
        (data) {
          setState(
            () {
              ...
              child: Row(
                ...
                children: <Widget>[
                  GestureDetector(
                    child: Text(
                      "Privacy Policy",
                      style: TextStyle(color: Color(0xff01b4c9)),
                    ),
                    onTap: () => launch(
                        "https://www.deligence.com/apps/hookup4u2/Privacy-Policy.html"), //TODO: add privacy policy
                  ),
                  GestureDetector(
                    child: Text(
                      "Terms & Conditions",
                    ...
                    onTap: () => launch(
                        "https://www.deligence.com/apps/hookup4u2/Terms-Service.html"), //TODO: add Terms and conditions
                  ),
                ],
              ),
            ),
