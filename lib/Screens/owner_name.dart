...
import 'package:hookup4u2/Screens/Gender.dart';
import 'package:hookup4u2/Screens/SexualOrientation.dart';
import 'package:hookup4u2/util/color.dart';

class OwnerName extends StatefulWidget {
  final dynamic userData;

  const OwnerName({Key key, this.userData}) : super(key: key);
  @override
                      ...
                      child: Align(
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            ...
                            widget.userData.addAll({'OwnerName': "$username"});
                            print(widget.userData);
                            Navigator.push(
                              context,
                              MaterialPageRoute(
